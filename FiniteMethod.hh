...
public:
    Grid xup(const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows - 1, ncols);
    ...
    Grid xdown(const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows - 1, ncols);
    ...
    Grid yup(const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows, ncols - 1);
    ...
    Grid ydown(const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows, ncols - 1);
...
public:
    ...
    Grid quad(const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        ...
        dvar = this->y(this->x(buffer));
        return dvar;
    }
    Grid x1(const Grid &wind, const Grid &var){
        // upwind transport
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows - 1, ncols);
    ...
    Grid y1(const Grid &wind, const Grid &var){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows, ncols - 1);
    ...
    Grid x1(const Grid &wind, const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows + 1, ncols);
        dvar.block(1, 0, nrows - 1, ncols) = this->x1(wind, var);
        dvar.row(0) = (var.row(0) + hal.left) / 2. +
    ...
    Grid y1(const Grid &wind, const Grid &var, const Halo &hal){
        int nrows = var.rows(), ncols = var.cols();
        Grid dvar;
        dvar.resize(nrows, ncols + 1);
        dvar.block(0, 1, nrows, ncols - 1) = this->y1(wind, var);
        dvar.col(0) = (var.col(0) + hal.bottom) / 2. + 
